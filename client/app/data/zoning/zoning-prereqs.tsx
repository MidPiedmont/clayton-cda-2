...
export const zoningPrereqs = [
    {
        ...
        tip: "Must include the property Identification (address or parcel number), contact information, current date of the letter, detailed description of request.",
    },
    {
        id: 1, 
        name: 'Site Plan or Survey', 
        tip: "Optional, but preferrable to have.",
    },
    {
        id: 2, 
        ...
        tip: 
            <Container css={{padding: "3px"}}>
                ...
                <Row justify="center">
                    ...
                    href="/ZoningRequirements/0" target="_blank"
                    >
